...
if __name__ == "__main__":
    ...
    df = load_data_into_dataframe("""SELECT
                                  ROW_NUMBER() OVER(ORDER BY complex_no DESC) AS seq,
    ...
    for apt_code in df['complex_no']:
        ...
        for dong in dong_list['buildingList']:
            ...
            insert_dataframe_into_table(df_dongho_info, 'naver_dongho_info', if_exists='append')
            print("Insert complete apt_code,dongNo:", apt_code, dongNo)

    # dongNo = 1
    # temp = get_dong_info(12076, dongNo)
    # data = []
    # for floor in temp["hoListOnFloor"]:
    #     for item in floor["pyeongHoList"]:
    #         if "hoNo" not in item:
    ...
    #                 "ho_no": item["hoNo"],
    #                 "ho_name": item["hoName"],
    #                 "ho_floor": item["hoFloor"],
    #                 "pyeong_no": item["pyeongNo"],
    #                 "pyeong_content": item["pyeongContent"],
    #                 "supply_area": item["supplyArea"],
    #                 "total_area": item["totalArea"],
    #                 "pyeong_class_string": item["pyeongClassString"],
    #                 "line_no": item["lineNo"],
    #                 "piloti_yn": item["pilotiYn"],
    #                 "exist_ho": item["existHo"],
    #                 "pyeong_name": item["pyeongName"],
    #                 "pyeong_name_decimal": item["pyeongNameDecimal"],
    #             }
    #         )
